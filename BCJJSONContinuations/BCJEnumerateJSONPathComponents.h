...
/**
 ...
 @param ^enumerator A block that will be invoked with each component of the JSONPath. Integer components are represented as an NSNumber object, string components as an NSString object.
