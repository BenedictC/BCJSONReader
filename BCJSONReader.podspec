#
#  Be sure to run `pod spec lint BCJSONReader.podspec' to ensure this is a
...
+ Extensible. Easy to integrate own code and still use BCJSONReader intrastructure.
  ...
  s.homepage     = "https://github.com/BenedictC/BCJSONReader"
  ...
  s.source       = { :git => "https://github.com/BenedictC/BCJSONReader.git", :tag => "0.4.0" }
